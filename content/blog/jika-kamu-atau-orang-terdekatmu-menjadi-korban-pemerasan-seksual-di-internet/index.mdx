...
import Screenshot from './Screenshot_3.png';

export * as banner from './Revenge-Porn.jpg';


Karena akhir-akhir ini maraknya terjadi penyebaran video porno di internet yang dilakukan tanpa izin oleh para pelaku tindakan tersebut. 28 November 2021 saya pernah sempat diminta untuk menjadi pembicara di FGD (Focus Group Discussion) salah satu kampus swasta ternama di Jakarta.
...
2. Dan dalam kasus tersebut juga sama seperti yang menimpa teman saya di instagram;
<Image
  src={Screenshot}
  alt="Screenshot_3.png"
  caption="Nama account di tutup untuk privacy korban"
/>
